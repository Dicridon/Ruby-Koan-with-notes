...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Notice that test_a_failed_match_returns_nil FAILED so we
    # have nil while * never fail. * will always accept ""
  ...
  # They mathch as many characters as possible
  # ------------------------------------------------------------------
  ...
  def test_slash_d_is_a_shortcut_for_a_digit_character_class
    ...
    # OK here is a hint: pay attention to the priority of + over []
    # [0123456789] will repeat at least once, then tries to match
    # any digit if there is any. Don't be confused.
    # The procedure is like [0123456789]+ becomes 
    # [123456789][123456789], then 4 and 2 are selected to match
    # the string
  end
