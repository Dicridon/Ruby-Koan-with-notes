...
class AboutSymbols < Neo::Koan
  ...
  def test_identical_symbols_are_a_single_internal_object
    ...
    # This is a bit like symbols in Lisp
  end
  ...
  # comparison between symbols and strings is always false
  # thus we can find a symbol using the name of this symbol
  # converting symbols to string would solve this
