...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # it seems that this method functions the same as reduce in 
    # other language

    # stackoverflow explanation: inject is an accumulator, inject(n)
    # use n as initialization value to the accumulator (sum to 0, product to 1)
  end
  ...
  # My guess is that do |file| end block work on file handle but returns
  # a status
end
